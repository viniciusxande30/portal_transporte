...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" sizes="56x56" href="{{url('/')}}/assets/images/logo.png">
	<!-- bootstrap CSS -->
	...
	<!-- animate CSS -->
	<link rel="stylesheet" href="{{url('/')}}/assets/css/animate.min.css" type="text/css" media="all">
	<!-- animated-text CSS -->
